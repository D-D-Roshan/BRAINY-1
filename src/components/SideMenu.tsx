...
function SideMenu({}: Props) {
  ...
  return (
    ...
    <SheetContent side='left' className='w-[250px] p-1 px-3 flex flex-col justify-between h-screen'>
        <SheetHeader>
            {/* <UserButton/> */}
        ...
        <UserButton />
            ...
            <Button className='w-full rounded-lg' variant='secondary'>Clear Chat</Button>
        </SheetFooter>
    </SheetContent>
    </Sheet>
  )
